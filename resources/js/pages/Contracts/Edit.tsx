...
export default function Edit({ contract }) {
  ...
  const { data, setData, put, processing } = useForm({
    ...
    quantity_contracted: contract.quantity_contracted || "",
    selling_price: contract.selling_price || "",
    status: contract.status || "open",

    invoice_paid: contract.invoice_paid || false,
    outside_payment_received: contract.outside_payment_received || false,

    bill_of_lading_received: contract.bill_of_lading_received || false,
    documents_sent_to_bank: contract.documents_sent_to_bank || false,

    has_claim: contract.has_claim || false,
    amount_settled_by_seller: contract.amount_settled_by_seller || "",

    notes: contract.notes || "",
    is_closed: contract.is_closed || false,
  })
